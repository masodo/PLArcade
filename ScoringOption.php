...
// ---------------------------------------------------------------------------------/
# Section: ScoringOption.php  Function: Highscore Collection/Submission   Modified: 4/26/2019  By: MaSoDo
...
<?php //FSmod EDIT ?>
 <td class='arcade1' align='center'><?php echo $gameinfo['about']; ?><br /><br /><a href='index.php?play=<?php echo $id ?>' class='navigation'> Play </a><div class='viewedtimes' style='font-size: 8px;'><?php echo "Played ".$gameinfo['times_played']." Time".($gameinfo['times_played']!=1?"s":""); ?></div></td>
...
//End Admin Play As
echo "<div class='tableborder'><script type=\"text/javascript\">alert(\"Congratulations! \\nYou are the NEW" . $WINNERTAG . "Champion!\")</script><table width='100%'><td class='arcade1' width='100%' align='center'><h2>Congratulations, you are the NEW " . $WINNERTAG . "Champion!</h2></td></table></div><br /><br />";
