...
echo "<tr><td class='arcade1'><div style='font-size:16px; color: gold;' align='center'>With <I>".$scoreboardc['HOF_champ']."</I> Games</div><div align='center' style='font-size:24px'><i><a href=\"index.php?action=profile&amp;user=".$scoreboardc['name']."\"><img src='".$scoreboardc['avatar']."' /><br /><span class='".$scoreboardc['group']."Look'>".$scoreboardc['name']."</span></a></i></div></td></tr>";
