...
// ---------------------------------------------------------------------------------/
# Section: functions.php  Function: PM Extension Functions   Modified: 6/27/2019   By: MaSoDo
/**
...
$string = preg_replace_callback('/(".*?(?<!\\\\)")/', function($found){ return strtolower($found[1]+1);}, $str);
