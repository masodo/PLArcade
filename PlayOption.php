...
// ---------------------------------------------------------------------------------/
# Section: PlayOption.php  Function: Game Play Block   Modified: 3/2/2019   By: MaSoDo
...
echo "</div>";
echo "<div style='position: relative; width:25px; margin-left:auto; margin-right:auto; margin-top: 60px;'>".$fav_action."</div>";
} else { 
