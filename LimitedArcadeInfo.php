...
// ---------------------------------------------------------------------------------/
# Section: LimitedArcadeInfo.php  Function: For Closed Arcade   Modified: 7/29/2019   By: MaSoDo
?>
<br />
<div align="center">
<table>
...
// begin nav buttons
?>
<div style="width: 100%; text-align: center; margin-left: auto; margin-right: auto;"><a name="Login"></a><div class="navigation">[ <a href="javascript:tog('login_form')">Login</a> ]</div><div class="navigation">[ <a href="index.php?action=register#registration">Register</a> ] </div>
