...
// ---------------------------------------------------------------------------------/
# Section: PageMakerT.php  Function: Makes Pages/Paging Top  Modified: 7/29/2019   By: MaSoDo
...
$next_p="<br /><a href='index.php?" . (!empty($_GET['plat']) ?"plat=".$plat."&amp;":"") . (!empty($_GET['cat']) ?"cat=".$cat."&amp;":"") . "limit=".$pagN_lim."&amp;show=".$num_pages_of."&amp;page=".$pag_next."&arcade=1{$favstuff}'>[&nbsp;NEXT&nbsp;] &raquo</a>";
if($pgn+2 == $pag_gen)  {
global $plat;
global $cat;
