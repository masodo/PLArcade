...
// ---------------------------------------------------------------------------------/
# Section: HeaderBlock.php  Function: Top of the Page   Modified: 2/28/2019   By: MaSoDo
...
echo "<div align='center' style='margin-top: 20px; width:100%;'>"; 
echo "<div style='position:relative; width:640px; top:-10px; font-size: 14px; color: yellow; background-color: navy; padding:3px;'>Currently Featuring <b>$CPF Flash</b> Games, <b>$CPH HTML5</b> Games &amp; <b>$CPD DOS</b> Games</div>";
