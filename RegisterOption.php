...
// ---------------------------------------------------------------------------------/
# Section: RegisterOption.php  Function: Register for the Arcade   Modified: 6/27/2019   By: MaSoDo
...
run_query("INSERT INTO `PLA_users` (`username`,`password`,`email`,`registration_ip`,`group_id`) VALUES ('$name','$pass','$email','$ipa','3')", 1);
if(isset($settings['enable_email_validation'])&&$settings['enable_email_validation'] != '1') { 
