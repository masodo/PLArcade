...
// ---------------------------------------------------------------------------------/
# Section: Categories.php  Function: Display Categories w/Icons   Modified: 2/28/2019   By: MaSoDo
...
if ($c[0] != '2') {
echo  "<div style='width: 45px; height: 45px; padding: 10px; float: left; margin-right: 5px; margin-bottom: 5px; text-align:center;' class='arcade1'><a href='index.php?cat=$c[0]' title='$c[1]'><img src='$catloc/$c[1].png' /><br />$c[1]</a></div>";
} }
