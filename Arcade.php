...
// ---------------------------------------------------------------------------------/
# Section: Arcade.php  Function: Main Organization Page   Modified: 2/28/2019   By: MaSoDo
//-----------------------------------------------------------------------------------/
...
elseif (isset($_GET['action']) && $_GET['action'] == "tournaments") require "./TournamentOption.php";
