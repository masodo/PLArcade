...
// ---------------------------------------------------------------------------------/
# Section: MembersOption.php  Function: Show the Members List   Modified: 6/9/2019   By: MaSoDo
...
echo "<tr><td class='arcade1'><a href='?action=profile&amp;user=".$f[0]."'>".$f[0]."</a></td><td class='arcade1'>".$f[1]."</td><td class='arcade1'>".$f[2]."</td><td class='arcade1'>".$LastOn."</td></tr>";
}
