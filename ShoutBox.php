...
// ---------------------------------------------------------------------------------/
# Section: ShoutBox.php  Function: ShoutBox Block   Modified: 2/28/2019   By: MaSoDo
...
if ($limit > 0) {
echo "<a href='index.php?cat=$cat&amp;limit=$limnm&amp;show=$num_pages_of&amp;page=$pgnm&shoutbox=1'>Previous Page ($pgnm)</a> ";
}
}
